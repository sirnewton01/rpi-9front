...
extern void gpiofuncset(uint, int);
extern void gpiopullset(uint, int);
extern void gpioout(uint, int);
extern void gpioshutdown(void);
extern Chan* gpioattach(char*);
extern Walkqid* gpiowalk(Chan*, Chan*, char**, int);
extern int gpiostat(Chan*, uchar*, int);
extern Chan* gpioopen(Chan*, int);
extern void gpioclose(Chan*);
extern long gpioread(Chan*, void*, long, vlong);
extern long gpiowrite(Chan*, void*, long, vlong);
...
extern void syscallfmt(ulong syscallno, uintptr pc, va_list list);
extern void sysretfmt(ulong syscallno, va_list list, uintptr ret, uvlong start, uvlong stop);
